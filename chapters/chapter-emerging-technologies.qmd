...
calculateDiscount("100", "10");  // "100" repeated 0.1 times = NaN-ish behaviour
...
This develops **assessing emerging technologies**. The ability to evaluate technologies objectively—separate from hype and personal preference—is essential for advising businesses on technology decisions.
:::
