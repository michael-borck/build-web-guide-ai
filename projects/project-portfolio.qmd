...
The online edition at [books.borck.education](https://books.borck.education) includes links to example implementations, starter code, and companion repositories for each project.
:::
