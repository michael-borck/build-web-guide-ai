...
::: {.callout-tip title="Example implementations available online"}
The online edition at [books.borck.education](https://books.borck.education) includes links to example implementations, WordPress backups, and companion resources for each project.
:::
